# Nego
1. 목표  
실제 중고거래 서비스의 사용자 흐름을 분석하고, 회원 가입부터 게시글 등록, 조회, 거래로 이어지는 전체 과정을 구조적으로 이해하는 것을 목표로 프로젝트를 진행했습니다. 이를 바탕으로 사용자가 서비스를 이용하는 흐름에 맞춰 게시글 등록·조회·거래 기능을 구현하며, 각 기능이 유기적으로 연결되도록 설계했습니다.
