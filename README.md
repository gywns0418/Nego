...
## 구현 화면 
[NeGO정리.pdf](https://github.com/user-attachments/files/24605764/NeGO.pdf)


## 담당 기능 상세 (김효준)

본 프로젝트에서 팀장으로서 전체 구조 설계를 주도했으며,  
다음 기능들을 중심으로 직접 구현 및 관리했습니다.
